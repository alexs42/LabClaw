...
Each skill is a `SKILL.md` file that instructs an AI agent **when** and **how** to use a specific scientific tool, database, or methodology — covering the full biomedical research lifecycle from literature search to manuscript writing.
